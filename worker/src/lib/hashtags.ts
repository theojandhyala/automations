...
/**
 * Converts model, legacy and owner-entered hashtag text into the discrete
 * tokens TikTok expects. In particular, `#gymtok#gymprogress` becomes two
 * tags instead of one malformed tag.
 */
