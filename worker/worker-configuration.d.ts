/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=WorkerEnv` (hash: 6d9ebbd37ea3949acf5acfd625fed090)
// Runtime types generated with workerd@1.20260828.1 2026-09-01 nodejs_compat
interface __BaseEnv_WorkerEnv {
	HQ_DATA: KVNamespace;
	DEADSET_BASELINE: KVNamespace;
	BROWSER: BrowserRun;
	AI: Ai;
	ASSETS: Fetcher;
	SUPABASE_URL: "https://ewmgvujlqvdctzryfbid.supabase.co";
	PUBLIC_BASE_URL: "https://automations.theojandhyala.workers.dev";
	TIKTOK_PUBLISH_PROVIDER: "business_accounts";
	TIKTOK_REVIEW_STATE: "approved";
	SUPABASE_ANON_KEY: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV3bWd2dWpscXZkY3R6cnlmYmlkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODgxMTM3ODMsImV4cCI6MjEwMzY4OTc4M30.sQBCfLDKp6u2ER7ANxnt_stCkbx6qXPWt2UcXo0bw_U";
	OWNER_EMAIL: "theojandhyala@icloud.com";
	SUPABASE_SERVICE_ROLE_KEY: string;
	TOKEN_ENCRYPTION_KEY: string;
	TIKTOK_CLIENT_KEY: string;
	TIKTOK_CLIENT_SECRET: string;
	TIKTOK_REDIRECT_URI: string;
	TIKTOK_BUSINESS_CLIENT_ID: string;
	TIKTOK_BUSINESS_CLIENT_SECRET: string;
	TIKTOK_BUSINESS_AUTH_URL: string;
	TIKTOK_BUSINESS_REDIRECT_URI: string;
	DEADSET_PRODUCT_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "PUBLIC_BASE_URL" | "TIKTOK_PUBLISH_PROVIDER" | "TIKTOK_REVIEW_STATE" | "SUPABASE_ANON_KEY" | "OWNER_EMAIL" | "SUPABASE_SERVICE_ROLE_KEY" | "TOKEN_ENCRYPTION_KEY" | "TIKTOK_CLIENT_KEY" | "TIKTOK_CLIENT_SECRET" | "TIKTOK_REDIRECT_URI" | "TIKTOK_BUSINESS_CLIENT_ID" | "TIKTOK_BUSINESS_CLIENT_SECRET" | "TIKTOK_BUSINESS_AUTH_URL" | "TIKTOK_BUSINESS_REDIRECT_URI" | "DEADSET_PRODUCT_KEY">> {}
}
